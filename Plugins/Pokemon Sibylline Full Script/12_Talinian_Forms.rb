...
MultipleForms.copy(:HOOTHOOT,:CHIKORITA,:LITTEN,:MANKEY,:JOLTIK,:POLIWAG,:RUFFLET,:BRAVIARY,:MAGNEMITE,:MAGNETON,:MAGNEZONE,:SOLOSIS,:SLAKOTH,:WOOBAT,:SWOOBAT,:PIKIPEK,:TRUMBEAK,:TOUCANNON)
