...
MultipleForms.copy(:HOOTHOOT,:NOCTOWL,:CHIKORITA,:BAYLEEF,:LITTEN,:TORRACAT,:MANKEY,:PRIMEAPE,:SANDILE,:KROKOROK,:KROOKODILE,:JOLTIK,:GALVANTULA,:POLIWAG,:POLIWHIRL,:POLIWRATH,:POLITOED,:RUFFLET,:BRAVIARY,:MAGNEMITE,:MAGNETON,:MAGNEZONE,:SOLOSIS,:DUOSION,:SLAKOTH,:VIGOROTH,:WOOBAT,:SWOOBAT,:PIKIPEK,:TRUMBEAK,:TOUCANNON,:DUNSPARCE,:PHANTUMP,:TREVENANT,:HEATMOR)
